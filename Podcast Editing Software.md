...
| Best for           | Free, DIY, control over every step                                                       | Teams with pro tools and has video                                               |                                                                                                |

What we can do with connector



Editing powerText-based editing (edit audio by editing a transcript), filler-word removal, Studio Sound cleanup, multi-track

Best forFree, DIY, control over every step

Best forTeams that want pro tools and may grow into video too

Best forPodcast-specific editing with the least setup friction